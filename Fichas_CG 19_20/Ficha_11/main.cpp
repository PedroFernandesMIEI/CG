...
void prepareCylinder(float altura, float raio, int lados) {
	...
	for (int i = 0; i < lados; ++i) {
        ...
        t[vertex*2 + 0] = 0.4375f + (0.1875f * cos( i * delta));
        t[vertex*2 + 1] = 0.1875f + (0.1875f * sin( i * delta));
        ...
        t[vertex*2 + 0] = 0.4375f + (0.1875f * cos( (i+1) * delta));
        t[vertex*2 + 1] = 0.1875f + (0.1875f * sin( (i+1) * delta));
		...
		v[vertex*3 + 1] = -altura/2.0f;
		v[vertex*3 + 2] = raio * cos( (i+1) * delta);
        t[vertex*2 + 0] = 0.8125f + 0.1875f * cos( (i+1) * delta);
        t[vertex*2 + 1] = 0.1875f + 0.1875f * sin( (i+1) * delta);
		...
		v[vertex*3 + 1] = -altura/2.0f;
		v[vertex*3 + 2] = raio * cos( i * delta);
        t[vertex*2 + 0] = 0.8125f + 0.1875f * cos( i * delta);
        t[vertex*2  + 1] = 0.1875f + 0.1875f * sin( i * delta);
